...
HUB_MQTT_BROKER_HOST = os.environ.get("HUB_MQTT_BROKER_HOST", "localhost")
HUB_MQTT_BROKER_PORT = try_parse_int(os.environ.get("HUB_MQTT_BROKER_PORT", 1883))
HUB_MQTT_TOPIC = os.environ.get("HUB_MQTT_TOPIC", "processed_agent_data_topic")

# Configuration for hub HTTP
HUB_HOST = os.environ.get("HUB_HOST", "localhost")
HUB_PORT = try_parse_int(os.environ.get("HUB_PORT", 9000))
